//module VirtualNode_Make = (
//  AttributeList: { type t; },
//  ChildList: { type t; }
//  ) => {
//  type t =
...
//}
//
//module ChildList_Make = (VirtualNode: { type t; }) => {
//  type nonrec t =
//    | Children(list(VirtualNode.t))
//    | Empty;
//  let map = (fn: (VirtualNode.t => 'a), childList: t) => {
//    switch(childList) {
...
//};
//
//module AttributeList_Make = (Attribute: { type t; }) => {
//  type nonrec t = 
//    | Attrs(list(Attribute.t))
//    | Empty;
//  let map = (fn: (Attribute.t => 'a), attrList: t) => {
//    switch(attrList) {
...
//
//
//// Recursively implement module functors so that the ChildList
//// module can read from the VirtualNode module and vice versa
//
...
//
//
//include VirtualNode_Impl; // Include final implementation in this module;
